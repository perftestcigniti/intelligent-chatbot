        ...
        if query_result.get('action') == 'google_calendar_email':
            ...
            if uncondat1[19] == '+':
                ...
                if presenttime > meetingtime:
                    ...
                    res = ful.main_response(fulfillment_messages=ful.fulfillment_messages([res_message]), fulfillment_text=None,
                    ...
                    #res = res_message
                    res = ful.main_response(fulfillment_messages=ful.fulfillment_messages([res_message]), fulfillment_text=None, output_contexts=None,followup_event_input=None)
                    globals()['res'] = res
